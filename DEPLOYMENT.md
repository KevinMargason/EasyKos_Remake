...
3. **Environment Variables**
   Add all variables from Step 1 (Option A) Config
...
1. **Server Requirements**
   ...
   - Composer
   - Nginx or Apache
   - PHP extensions: mongodb, curl, mbstring, xml, zip

2. **Install Dependencies**
```bash
sudo apt update
sudo apt install php8.3 php8.3-fpm php8.3-mongodb php8.3-curl php8.3-mbstring php8.3-xml php8.3-zip composer nginx
```

3. **Deploy Application**
```bash
cd /var/www
git clone https://github.com/youruser/EasyKos_Remake.git
cd EasyKos_Remake/backend
...
server {
    ...
    root /var/www/EasyKos_Remake/backend/public;
...
7. **Set Permissions**
```bash
sudo chown -R www-data:www-data /var/www/EasyKos_Remake/backend
sudo chmod -R 755 /var/www/EasyKos_Remake/backend/storage
```
