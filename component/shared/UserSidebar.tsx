...
const userSidebarItems: Array<{
...
}> = [
  {
    ...
    icon: "/Asset/icon/icon-house2.svg",
    activeIconClassName:
      "brightness-0 saturate-100 invert-[42%] sepia-[68%] saturate-[1650%] hue-rotate-[337deg] brightness-[97%] contrast-[92%]",
  },
  {
    label: "Kos Saya",
    href: ROUTES.USER.MYKOS,
    icon: "/Asset/icon/icon-apartment.svg",
    activeIconClassName:
      "brightness-0 saturate-100 invert-[42%] sepia-[68%] saturate-[1650%] hue-rotate-[337deg] brightness-[97%] contrast-[92%]",
  },
  {
    ...
    icon: "/Asset/icon/icon-chat2.svg",
    activeIconClassName:
      "brightness-0 saturate-100 invert-[42%] sepia-[68%] saturate-[1650%] hue-rotate-[337deg] brightness-[97%] contrast-[92%]",
  },
  {
    ...
    icon: "/Asset/icon/icon-profile.svg",
    activeIconClassName:
      "brightness-0 saturate-100 invert-[42%] sepia-[68%] saturate-[1650%] hue-rotate-[337deg] brightness-[97%] contrast-[92%]",
  },
  {
    ...
    <aside className="sticky top-0 hidden h-screen w-[230px] shrink-0 border-r border-slate-200/80 bg-white/95 px-5 py-6 shadow-[8px_0_24px_rgba(15,23,42,0.04)] dark:border-slate-800 dark:bg-slate-900/95 dark:shadow-[8px_0_24px_rgba(0,0,0,0.25)] lg:flex lg:flex-col">
            ...
            >
              <div className="relative h-5 w-5 shrink-0">
                <Image
                  ...
                  alt={label}
                  fill
                  className="object-contain brightness-0 saturate-100 opacity-60 dark:brightness-0 dark:invert dark:opacity-80"
                />
              </div>
              <span>{label}</span>
            </Link>
      ...
      <div className="mt-auto border-t border-slate-200 pt-4 dark:border-slate-800">
        <button
          ...
          data-tour={
            role === "owner" ? "owner-sidebar-logout" : "user-sidebar-logout"
          }
